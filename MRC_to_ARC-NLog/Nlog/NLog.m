...
- (id)initWithAppId:(NSString *)appId {
    if (self = [super init]){
        ...
        _session = [NSession sharedInstance];
        
        _storage = [NStorage sharedInstance];
        
        _logConfig = [NLogConfig sharedInstance];
        
        _sender = [NSender sharedInstance];
...
- (id)initWithAppId:(NSString *)appId configs:(NSDictionary *)configs {
    if (self = [super init]){
        ...
        _logConfig = [NLogConfig sharedInstanceWith:configs];
...
- (void) lazyActionAfterInit{
    ...
    NSString* currentAV = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"];
...
+ (void) startWithAppId:(NSString *)appid {
    //    ZDLogDebug(@"NLog started with appid: %@", appid);
